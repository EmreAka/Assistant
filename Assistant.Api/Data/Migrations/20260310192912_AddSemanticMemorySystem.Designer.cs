...
namespace Assistant.Api.Data.Migrations
{
    ...
    [Migration("20260310192912_AddSemanticMemorySystem")]
    partial class AddSemanticMemorySystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assistant.Api.Domain.Entities.UserMemory", b =>
                {
                    ...
                    b.Property<int?>("MergedIntoMemoryId")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Assistant.Api.Domain.Entities.UserMemory", b =>
                {
                    b.HasOne("Assistant.Api.Domain.Entities.UserMemory", "MergedIntoMemory")
                        .WithMany("MergedMemories")
                        .HasForeignKey("MergedIntoMemoryId")
